...
def procesarTrx(h):
    ...
    if codetrx == "100":
        ...
        if ( hayf >=0):
                ...
                fileJsonWebPos.write('"customerAddress":"Santiago Veraguas",\n')
                fileJsonWebPos.write('"email":"jacenteno@gmail.com",\n')
                ...
                if verFileJson=='1':
                    ...
                    try:
                        ...
                        if response:
                                ...
                                json_formatted_str = json.dumps(respuesta, indent=2)
                                logging.warning('\n'+json_formatted_str)
                        else:
...
def waitForFile():
    if fileIdcExiste:
        ...
        print (Fore.LIGHTRED_EX+"[ %s" % time.ctime()+Fore.LIGHTYELLOW_EX+"]- Wait by Idc ")
